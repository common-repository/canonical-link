...
Activate and then set your permalinks to "Post name" under *Settings > Permalinks*. That's it.

Verify that it's working correctly with the [Firefox add-on](https://addons.mozilla.org/addon/canonical-link/).

Supports the ability to customize the canonical link for any specific page, post, or even custom post types (including WooCommerce Products and bbPress Topics).
...
You will also need to update your permalinks (if you haven't already), which will give you desirable SEO-friendly and user-friendly URLs anyway:
...
= 1.4 =
* Added support for custom canonical links on single pages and posts

= 1.3 =
* Added https support

= 1.2 =
* Removed syntax error from code

= 1.1 =
* Cleans URLs better, removing query strings (**?**)
